  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        note: "Hard-folding tonneau — works with the bed rack",
        href: AMZ("#"),
        badge: "Amazon",
      },
      {
        name: "RealTruck UnderCover SwingCase Truck Bed Toolbox",
    ...
    items: [
      {
        ...
        note: "95L dual zone. Left side fridge, right side freezer. The best overlanding fridge I've owned.",
        href: AMZ("#"),
        badge: "Amazon",
      },
      {
      ...
      },
      {
        ...
        note: "Custom slide for the 95DZ — mounts in the bed rib valley",
        href: AMZ("#"),
        badge: "Amazon",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        note: "Weatherproof 102L hard case. Mounts TBD — mounts are currently on backorder from OpenRoad.",
        href: AMZ("#"),
        badge: "Amazon",
        incoming: true,
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        note: "Wall-mount bracket for the AY132B heater. Just picked this up.",
        href: AMZ("#"),
        badge: "Amazon",
      },
      {
