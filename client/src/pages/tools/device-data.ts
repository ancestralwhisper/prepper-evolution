...
export const deviceCategories: DeviceCategory[] = [
  ...
  },
  {
    ...
    devices: [
      ...
      { id: "starlink-std", name: "Starlink Standard", watts: 75, category: "communication", defaultHours: 8, essential: false, note: "50-100W depending on conditions" },
...
export const powerStations: PowerStationRec[] = [
  { id: "jackery-300p", name: "Jackery Explorer 300 Plus", capacityWh: 288, maxOutputW: 300, price: "$249", affiliateUrl: A("B0CG5J98QL"), note: "Ultraportable, great for phones/lights" },
  { id: "ecoflow-river2", name: "EcoFlow RIVER 2", capacityWh: 256, maxOutputW: 300, price: "$179", affiliateUrl: A("B0BT3GFN2K"), note: "Fastest recharge in class (60 min)" },
  ...
  { id: "ecoflow-delta2", name: "EcoFlow DELTA 2", capacityWh: 1024, maxOutputW: 1800, price: "$649", affiliateUrl: A("B0BCC7SRQH"), note: "Best value mid-range" },
  { id: "bluetti-ac200max", name: "Bluetti AC200MAX", capacityWh: 2048, maxOutputW: 2200, price: "$1,599", affiliateUrl: A("B09P2JD3SR"), note: "LiFePO4 — 3,500+ cycles" },
  { id: "ecoflow-delta2max", name: "EcoFlow DELTA 2 Max", capacityWh: 2048, maxOutputW: 2400, price: "$1,599", affiliateUrl: A("B0BV33V5LN"), note: "Expandable to 6kWh" },
  { id: "bluetti-ac200l", name: "Bluetti AC200L", capacityWh: 2048, maxOutputW: 2400, price: "$1,199", affiliateUrl: A("B0CLKMLG8D"), note: "LiFePO4, expandable, WiFi app control" },
  { id: "ecoflow-deltapro", name: "EcoFlow DELTA Pro", capacityWh: 3600, maxOutputW: 3600, price: "$2,399", affiliateUrl: A("B09PR7K68D"), note: "Home backup capable — expandable to 25kWh" },
  { id: "bluetti-ep500", name: "Bluetti EP500", capacityWh: 5100, maxOutputW: 2000, price: "$3,499", affiliateUrl: A("B0B7FGSM12"), note: "Whole-home backup, UPS function" },
  { id: "gz-yeti-500x", name: "Goal Zero Yeti 500X", capacityWh: 505, maxOutputW: 300, price: "$400", affiliateUrl: A("B08VRJ7L5V"), note: "Lightweight, chain with Yeti Link" },
  ...
  { id: "anker-c1000", name: "Anker SOLIX C1000", capacityWh: 1056, maxOutputW: 1800, price: "$599", affiliateUrl: A("B0BZ6SCK6S"), note: "HyperFlash recharge in 58 min" },
  { id: "bluetti-eb3a", name: "Bluetti EB3A", capacityWh: 268, maxOutputW: 600, price: "$199", affiliateUrl: A("B09YQ8MVTV"), note: "UPS mode, great for CPAP travel" },
  { id: "ecoflow-river2max", name: "EcoFlow RIVER 2 Max", capacityWh: 512, maxOutputW: 500, price: "$349", affiliateUrl: A("B0BT3JPG8R"), note: "X-Boost to 1000W for small appliances" },
  { id: "anker-f2000", name: "Anker SOLIX F2000 (PowerHouse 767)", capacityWh: 2048, maxOutputW: 2400, price: "$1,399", affiliateUrl: A("B09PQXNYQS"), note: "LiFePO4, 3000+ cycles" },
  { id: "jackery-2000p", name: "Jackery Explorer 2000 Plus", capacityWh: 2042, maxOutputW: 3000, price: "$1,899", affiliateUrl: A("B0CG5G1VDP"), note: "Expandable to 12kWh, LiFePO4" },
];
...
export const solarPanels: SolarPanelRec[] = [
  { id: "jackery-100", name: "Jackery SolarSaga 100W", watts: 100, price: "$300", affiliateUrl: A("B0B5MK1HMG"), note: "Foldable, 100W", portable: true },
  { id: "bigblue-100", name: "BigBlue 100W Solar Panel", watts: 100, price: "$200", affiliateUrl: A("B0CHXFLRG1"), note: "Budget foldable", portable: true },
  ...
  { id: "ecoflow-220", name: "EcoFlow 220W Bifacial Panel", watts: 220, price: "$399", affiliateUrl: A("B09ZCPSMXR"), note: "Bifacial — captures reflected light", portable: true },
  { id: "jackery-200", name: "Jackery SolarSaga 200W", watts: 200, price: "$500", affiliateUrl: A("B09NRF8NW4"), note: "Higher efficiency PERC cells", portable: true },
  { id: "ecoflow-400", name: "EcoFlow 400W Portable Panel", watts: 400, price: "$599", affiliateUrl: A("B09ZPPHVG6"), note: "Best watts/dollar for large systems", portable: true },
  ...
  { id: "rigid-200", name: "Renogy 200W Rigid Panel", watts: 200, price: "$170", affiliateUrl: A("B0BYC89FNH"), note: "Permanent mount — best efficiency", portable: false },
  { id: "gz-nomad-50", name: "Goal Zero Nomad 50", watts: 50, price: "$195", affiliateUrl: A("B07G98JDCB"), note: "Compact foldable, great for phones", portable: true },
  { id: "anker-ps100", name: "Anker SOLIX PS100", watts: 100, price: "$190", affiliateUrl: A("B0BXDMJPQY"), note: "IP67, lightweight foldable", portable: true },
  { id: "gz-boulder-100", name: "Goal Zero Boulder 100 Briefcase", watts: 100, price: "$250", affiliateUrl: A("B07GFZRVWP"), note: "Rugged aluminum frame", portable: true },
  { id: "bluetti-pv200", name: "Bluetti PV200", watts: 200, price: "$350", affiliateUrl: A("B098JDQH32"), note: "23.4% efficiency, foldable", portable: true },
  { id: "renogy-flex-100", name: "Renogy 100W Flexible", watts: 100, price: "$130", affiliateUrl: A("B09136YJRX"), note: "Flexible — mounts on curved surfaces", portable: false },
  { id: "ecoflow-160", name: "EcoFlow 160W Portable", watts: 160, price: "$300", affiliateUrl: A("B09ZPKZQSJ"), note: "Kickstand, pairs with RIVER series", portable: true },
  { id: "jackery-80", name: "Jackery SolarSaga 80", watts: 80, price: "$250", affiliateUrl: A("B0B5MF5J4C"), note: "Double-sided, lightweight", portable: true },
  { id: "bougerv-200", name: "BougeRV 200W", watts: 200, price: "$280", affiliateUrl: A("B0BM3P4N2Q"), note: "Budget 200W option, CIGS tech", portable: true },
];
