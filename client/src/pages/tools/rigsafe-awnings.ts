...
export const awningDatabase: AwningEntry[] = [
  ...
  },
  {
    ...
    notes: "SKU 2796. Quick-deploy design, 2 extra support tubes. Ripstop polyester, 1000D PVC cover (Tactical Grey). Passenger side only. Smaller coverage than the driver-side 2795 (80 vs 120 sq ft). WEIGHT UNCONFIRMED. $618.99.",
  },
  {
    id: "smittybilt-180",
    brand: "Smittybilt",
    ...
    notes: "SKU 2794. 600D Oxford polyester, 1000D PVC cover. 85+ sq ft coverage. Wall kit #2894 sold separately. WEIGHT UNCONFIRMED. $599.99.",
  },
...

  {
    id: "alltop-180",
    brand: "ALL-TOP",
    model: "Vehicle Awning 8.2ft",
    type: "180",
    mountSide: "either",
    totalWeightLbs: 0,
    mountedBracketWeightLbs: 10,
    deployedCoverageSqFt: 67,
    hasWallKit: false,
    wallKitCreatesSleeping: false,
    affiliateUrl: "https://www.amazon.com/s?k=ALL-TOP+vehicle+awning&tag=prepperevo-20",
    notes: "Budget 180. 8.2'×8.2' coverage (~67 sq ft). UV50+, weatherproof, ripstop fabric. Frequently described as a Rhino Rack clone. Universal hardware included. WEIGHT UNCONFIRMED. ~$180–$250.",
  },
  {
    id: "vevor-180",
    brand: "VEVOR",
    model: "Vehicle Awning (180)",
    type: "180",
    mountSide: "either",
    totalWeightLbs: 0,
    mountedBracketWeightLbs: 10,
    deployedCoverageSqFt: 55,
    hasWallKit: false,
    wallKitCreatesSleeping: false,
    affiliateUrl: "https://www.amazon.com/s?k=VEVOR+vehicle+awning+180&tag=prepperevo-20",
    notes: "Budget 180. Multiple size options — 4.6'×6.6' up to 6.6'×10'. PU3000mm waterproof, retractable, UV50+. Popular budget pick for smaller rigs. WEIGHT UNCONFIRMED. ~$150–$300.",
  },
  {
    id: "vevor-270",
    brand: "VEVOR",
    ...
    notes: "Budget 270 with integrated LED lighting. 117 sq ft coverage. Driver or passenger side options. Waterproof, UV50+, all-weather. Frequently cited as a cheap OVS/Rhino alternative. WEIGHT UNCONFIRMED. ~$300–$450.",
  },
  {
    id: "joytutus-180",
    brand: "JOYTUTUS",
    ...
    hasWallKit: false,
    wallKitCreatesSleeping: false,
    affiliateUrl: "https://www.amazon.com/s?k=JOYTUTUS+vehicle+awning&tag=prepperevo-20",
    notes: "Budget 180. 8.2'×10' and similar sizes. Waterproof/UV-proof polyester, adjustable hardware, quick setup. Regularly in Amazon top sellers for truck/SUV. WEIGHT UNCONFIRMED. ~$200–$350.",
  },
  {
    id: "sanhima-180",
    brand: "San Hima",
  ...
  },
  {
    ...
    hasWallKit: false,
    wallKitCreatesSleeping: false,
    affiliateUrl: "https://www.amazon.com/s?k=Timber+Ridge+retractable+car+awning&tag=prepperevo-20",
    notes: "Budget 180. Large blackout versions up to 19'×9.8' (186 sq ft). UPF50+, blackout coating. More shelter-scale than most vehicle awnings. Good for family/overland base camp use. WEIGHT UNCONFIRMED. ~$200–$400.",
  },
  {
    ...
    notes: "Budget 180 sector style. 6.6 ft pull-out. Ripstop, reinforced hinges and poles. Fans out in a semi-circle for better coverage than flat-arm awnings. Covers 4–8 people per listing. WEIGHT AND COVERAGE UNCONFIRMED. ~$200–$350.",
  },
  {
    ...
    hasWallKit: false,
    wallKitCreatesSleeping: false,
    affiliateUrl: "https://www.amazon.com/s?k=Bunker+Indust+270+awning+LED&tag=prepperevo-20",
    notes: "Mid-budget 270 with multi-color LED lighting. Stainless knuckle joints, waterproof/wind-resistant. Closest to mid-range quality in the budget 270 space. Users report good durability for the price. WEIGHT AND COVERAGE UNCONFIRMED. ~$500–$650.",
  },
];
