...
export const awningDatabase: AwningEntry[] = [
  ...
  },
  {
    ...
    notes: "Budget 270. JOYTUTUS does not make a 180 — 270 only. 125 sq ft coverage. Waterproof/UV-proof polyester, adjustable hardware, quick setup. ~$200–$350.",
  },
  {
    id: "sanhima-180",
    brand: "San Hima",
  ...
  },
  {
    ...
    notes: "ASIN B0DSBJMGFF. Softshell roll-up design — stores in a bag mounted to the roof rack. 186 sq ft shade. Blackout coating, UPF50+. Open dims: 160\"W × 70\"D × 70\"H. Good for base camp / family setups. WEIGHT UNCONFIRMED. ~$200–$400.",
  },
  {
